...
$(document)
		.ready(
				function() {
					...
					// it opens it up but I want it put into a div within the page that lists the rooms.
//					$("#aHList").click(function(){
//						var ref = window.open(encodeURI('http://www.myeventube.com/assets/assets/test/test3.html'), '_blank', 'location=yes');
...
//					});
				...
				function populateDBBuilding(tx) {
						tx
...
// });
					...
					// when passing the json object name it 'client'!!!
